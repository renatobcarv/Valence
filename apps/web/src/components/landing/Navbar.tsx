    ...
    <nav className="fixed top-0 w-full z-[100] border-b border-[#2a2a2a] bg-black/50 backdrop-blur-xl">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-8">
                <a href="#problem" className="text-xs font-bold text-[#b3b3b3] hover:text-white transition-colors tracking-widest uppercase">Problema</a>
                <a href="#solution" className="text-xs font-bold text-[#b3b3b3] hover:text-white transition-colors tracking-widest uppercase">Solução</a>
                <a href="#features" className="text-xs font-bold text-[#b3b3b3] hover:text-white transition-colors tracking-widest uppercase">Recursos</a>
